...
def evaluate_and_save(model_path, seed, circuit_name="PR", avatar_name="robot_stage1", role="AE", num_episodes=5, deterministic=True, enable_visualization=False):
    ...
    try:
        ...
        env = Simulation(logger, robot, env_obj, None, ipc_queue, None, pause_val, exit_val, enable_visualization_val, realtime_val, camera_selection_val, config_changed_value, num_episodes)
