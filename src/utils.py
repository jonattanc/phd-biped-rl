...
MODELS_DATA_PATH = os.path.join(DATA_PATH, "Models")
ESPECIALISTA_DATA_PATH = os.path.join(DATA_PATH, "Especialista")
CRUZADA_DATA_PATH = os.path.join(DATA_PATH, "Cruzada")
