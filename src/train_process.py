...
def process_runner(selected_environment, selected_robot, algorithm, ipc_queue, pause_value, exit_value, enable_visualization_value, enable_real_time_value, device="cpu"):
    ...
    logger.info(f"Visualização: {enable_visualization_value.value}, Tempo Real: {enable_real_time_value.value}")
