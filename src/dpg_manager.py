    ...
    def __init__(self, custom_logger=None):
        ...
        self.phase_weight_adjustments = {
            ...
            2: {    # Fase 2: Foco em Progresso e Estabilidade
                ...
                'propulsion_efficiency': 5.0,   
                'knee_flexion': 5.0,
                'hip_extension': 5.0,
                'foot_clearance': 5.0,  
                'adaptability_bonus': 5.0,
            ...
            3: {    # Fase 3: Foco em Sucesso e Velocidade
                ...
                'pitch_forward_bonus': 10.0,
                'propulsion_efficiency': 10.0, 
                'knee_flexion': 10.0, 
                'hip_extension': 10.0,
                'foot_clearance': 10.0,    
                'adaptability_bonus': 10.0,
                'gait_pattern_cross': 15.0, 
                'efficiency_bonus': 5.0,  
                'distance_bonus': 10.0,    
                'alternating_foot_contact': 6.0, 
                'gait_rhythm': 4.0,        
                'success_bonus': 10.0,      
                'fall_penalty': 3.0,       
                'yaw_penalty': 3.0,    
                'foot_back_penalty': 5.0, 
