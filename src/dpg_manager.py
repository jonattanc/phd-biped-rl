    ...
    def __init__(self, custom_logger=None):
        ...
        self.phase_weight_adjustments = {
            ...
            2: {    # Fase 2: Foco em Progresso e Estabilidade
                ...
                'propulsion_efficiency': 50.0,   
                'distance_bonus': 25.0,       
                'alternating_foot_contact': 10.0,
                'efficiency_bonus': 50.0,
                'adaptability_bonus': 50.0,
                'gait_rhythm': 50.0,
                'fall_penalty': 3.0,
                'foot_back_penalty': 3.0, 
                'y_axis_deviation_square_penalty': 3.0, 
            ...
            3: {    # Fase 3: Foco em Sucesso e Velocidade
                ...
                'xcom_stability': 10.0,  
                'simple_stability': 10.0, 
                'progress': 3.0,
                'knee_flexion': 10.0, 
                'hip_extension': 10.0,
                'foot_clearance': 15.0,    
                'gait_pattern_cross': 20.0, 
                'propulsion_efficiency': 100.0, 
                'distance_bonus': 100.0,    
                'alternating_foot_contact': 10.0, 
                'efficiency_bonus': 100.0,  
                'adaptability_bonus': 100.0,
                'gait_rhythm': 100.0,        
                'success_bonus': 100.0,      
                'fall_penalty': 6.0,       
                'yaw_penalty': 6.0,    
                'foot_back_penalty': 6.0, 
                'y_axis_deviation_square_penalty': 6.0,   
                'foot_inclination_penalty': 6.0,
                'stability_roll': 6.0, 
                'stability_yaw': 6.0,
            }
        }
