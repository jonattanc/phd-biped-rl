    ...
    def __init__(self, custom_logger=None):
        ...
        self.phase_weight_adjustments = {
            ...
            2: {    # Fase 2: Foco em Progresso e Estabilidade
                ...
                'propulsion_efficiency': 15.0,   
                'knee_flexion': 5.0,
                'hip_extension': 9.0,
                'foot_clearance': 5.0,  
                'adaptability_bonus': 8.0,
            ...
            3: {    # Fase 3: Foco em Sucesso e Velocidade
                'gait_state_change': 15.0,
                'progress': 25.0,          
                'xcom_stability': 15.0,  
                'simple_stability': 12.0, 
                'pitch_forward_bonus': 15.0,
                'propulsion_efficiency': 25.0, 
                'knee_flexion': 12.0, 
                'hip_extension': 30.0,
                'foot_clearance': 20.0,    
                'adaptability_bonus': 15.0,
