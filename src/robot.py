...
class Robot:
    def __init__(self, name, base_position=[0, 0, 0], base_orientation=[0, 0, 0], tmp_dir="tmp", models_dir=os.path.join("models", "robots")):
        self.name = name
    ...
    def _generate_urdf(self):
        ...
        urdf_path = os.path.join(self.tmp_dir, f"{self.name}.urdf")
