            ...
            PhaseGroup(
                ...
                sub_phases=[
                    ...
                    SubPhaseConfig(
                        ...
                        target_speed=0.1,
                        enabled_components=["stability", "basic_progress", "posture", "clearance"],
                        component_weights={"stability": 0.4, "basic_progress": 0.3, "posture": 0.2, "clearance": 0.1},
                        min_episodes=8,
            ...
            PhaseGroup(
                ...
                sub_phases=[
                    ...
                    SubPhaseConfig(
                        name="marcha_basica",
                        target_speed=0.8,
                        enabled_components=["velocity", "stability", "phase_angles", "propulsion", "coordination"],
                        component_weights={"velocity": 0.25, "stability": 0.25, "phase_angles": 0.25, "propulsion": 0.15, "coordination": 0.15},
                        min_episodes=12,
                        transition_conditions={
                            "min_success_rate": 0.5,
