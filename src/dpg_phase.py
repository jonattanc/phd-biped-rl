...
class AdaptiveValidator:
    ...
    def should_validate(self, group_level: int, performance_trend: float, consecutive_failures: int, episodes_in_phase: int) -> Tuple[bool, str]:
    ...
    def distributed_validation(self, group_config: PhaseGroup, sub_phase_config: SubPhaseConfig, performance_history: List[Dict]) -> Dict[str, bool]:
        ...
        self.validation_history.append(
            {"episode": len(performance_history), "group": group_config.group_level, "sub_phase": sub_phase_config.name, "results": validations, "timestamp": np.datetime64("now")}
        )
...
class PhaseManager:
    ...
    def _initialize_groups(self):
        ...
        return [
            ...
            PhaseGroup(
                ...
                adaptive_config={"validation_frequency": "medium", "irl_requirement": "light", "critic_complexity": "basic", "learning_preservation": "high"},
                sub_phases=[
                    # Sub-fase 1.1: Estabilidade Inicial
                    SubPhaseConfig(
                        name="estabilidade_inicial",
                        target_speed=0.1,
                        enabled_components=["stability", "basic_progress", "posture", "weight_transfer", "clearance"],
                        component_weights={"stability": 0.5, "basic_progress": 0.3, "posture": 0.2, "weight_transfer": 0.2, "clearance": 0.1},
                        min_episodes=8,
                        transition_conditions={
                            ...
                            "min_clearance_score": 0.4,
                            "min_weight_transfer_score": 0.3,
                            "min_forward_progress": 0.2,
                        },
                        focus_skills=["basic_balance", "postural_stability", "knee_lift", "weight_transfer"],
                    ...
                    SubPhaseConfig(
                        ...
                        target_speed=0.5,
                        enabled_components=["stability", "basic_progress", "posture", "velocity", "weight_transfer", "clearance", "gait_pattern"],
                        component_weights={"stability": 0.4, "basic_progress": 0.3, "posture": 0.2, "velocity": 0.1, "weight_transfer": 0.15, "clearance": 0.1, "gait_pattern": 0.05},
                        min_episodes=10,
                        transition_conditions={
                            ...
                            "max_avg_roll": 0.8,
                            "min_avg_speed": 0.1,
                            "min_clearance_score": 0.5,
                            "min_weight_transfer_score": 0.4,
                            "min_forward_progress": 0.3,
                        },
                        focus_skills=["postural_stability", "gait_initiation", "dynamic_weight_transfer", "consistent_knee_lift"],
                        validation_requirements={},
                        complexity_level=1,
                    ),
                ],
            ...
            PhaseGroup(
                ...
                adaptive_config={"validation_frequency": "high", "irl_requirement": "standard", "critic_complexity": "standard", "learning_preservation": "medium"},
                sub_phases=[
                    # Sub-fase 2.1: Marcha Básica
                    SubPhaseConfig(
                        name="marcha_basica",
                        target_speed=0.8,
                        enabled_components=["velocity", "stability", "phase_angles", "propulsion", "forward_progress", "gait_pattern"],
                        component_weights={"velocity": 0.3, "stability": 0.25, "phase_angles": 0.25, "propulsion": 0.2, "forward_progress": 0.1, "gait_pattern": 0.1},
                        min_episodes=12,
                        transition_conditions={
                            "min_success_rate": 0.5,
                            ...
                            "min_clearance_score": 0.6,  
                            "min_weight_transfer_score": 0.5,  
                            "min_forward_progress": 0.4,
                        },
                        focus_skills=["step_consistency", "dynamic_balance", "rhythmic_gait", "efficient_propulsion"],
                        validation_requirements={},
                        complexity_level=2,
                    ),
                    ...
                    SubPhaseConfig(
                        ...
                        target_speed=1.2,
                        enabled_components=["velocity", "stability", "propulsion", "coordination", "forward_progress", "gait_pattern"],
                        component_weights={"velocity": 0.25, "stability": 0.2, "propulsion": 0.25, "coordination": 0.3, "forward_progress": 0.1, "gait_pattern": 0.1},
                        min_episodes=15,
                        transition_conditions={"min_success_rate": 0.6, "min_avg_distance": 1.5, "max_avg_roll": 0.6, "min_avg_speed": 0.4, "min_gait_coordination": 0.4, "min_clearance_score": 0.7, "min_weight_transfer_score": 0.6, "min_forward_progress": 0.5},
                        focus_skills=["gait_coordination", "rhythmic_pattern", "energy_efficient_gait", "dynamic_clearance"],
                        validation_requirements={},
                        complexity_level=2,
                    ),
                ],
            ...
            PhaseGroup(
                ...
                adaptive_config={"validation_frequency": "light", "irl_requirement": "advanced", "critic_complexity": "advanced", "learning_preservation": "low"},
                sub_phases=[
                    ...
                    SubPhaseConfig(
                        ...
                        min_episodes=18,
                        transition_conditions={"min_success_rate": 0.7, "min_avg_distance": 2.0, "max_avg_roll": 0.5, "min_avg_speed": 0.6, "min_gait_coordination": 0.5},
                    ...
                    SubPhaseConfig(
                        ...
                        min_episodes=20,
                        transition_conditions={"min_success_rate": 0.8, "min_avg_distance": 3.0, "max_avg_roll": 0.3, "min_avg_speed": 0.8, "min_gait_coordination": 0.6, "min_energy_efficiency": 0.5},
    ...
    def execute_validation(self) -> Dict[str, bool]:
        ...
        return self.validator.distributed_validation(self.current_group_config, self.current_sub_phase_config, self.performance_history)
    ...
    def _is_final_sub_phase(self) -> bool:
        ...
        return self.current_group == len(self.groups) - 1 and self.current_sub_phase == len(self.current_group_config.sub_phases) - 1
    ...
    def _update_success_counters(self, episode_results: Dict):
        ...
        if len(self.performance_history) >= 50:
            ...
            if std_recent < 0.4 and abs(current_distance - avg_recent) < 0.6 and current_distance < 0.2 and self.episodes_in_sub_phase > 100:
