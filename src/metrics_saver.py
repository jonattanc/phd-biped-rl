...
def save_complexity_metrics(metrics, circuit_name, avatar_name, role="AE", 
                           seed=42, hyperparams=None, output_dir="logs/data"):
    """
    ...
    with open(filepath, 'w', newline='', encoding='utf-8') as csvfile:
        fieldnames = [
            'timestamp', 'circuit', 'avatar', 'role', 'seed', 
            'repetition', 'time_total', 'success', 'hyperparams'
        ]
